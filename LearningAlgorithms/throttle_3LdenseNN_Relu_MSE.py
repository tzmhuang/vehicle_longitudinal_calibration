...
#CONFIGS
model_name_ = 'throttle_3LdenseNN_Relu_MSE'
...
#NN FUNCTIONS
def NN_DenseRelu(x, W, b, name):
    with tf.name_scope(name):
        a = tf.nn.relu(tf.add(tf.matmul(x,W), b))
    return a

def NeuralNet(x, weights, biases):
    layer_1 = NN_DenseRelu(x, weights['layer1'], biases['layer1'], name='Layer_1')
    layer_2 = NN_DenseRelu(layer_1, weights['layer2'], biases['layer2'], name='Layer_2')
    layer_3 = NN_DenseRelu(layer_2, weights['layer3'], biases['layer3'], name='Layer_3')
